...
npcType.onBuyItem = function(npc, player, itemId, subType, amount, ignore, inBackpacks, totalCost)
	...
	player:sendTextMessage(MESSAGE_INFO_DESCR, string.format("Comprou %ix %s por %i %s. Muito corno mesmo", amount, name, totalCost, ItemType(npc:getCurrency()):getPluralName():lower()))
end
