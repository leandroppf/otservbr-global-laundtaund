...
npcConfig.shop = {
	-- HuntsMan rank
	-- Sell offers
	{clientId = 10297, sell = 50, itemName = "antlers", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 9633, sell = 100, itemName = "bloody pincers", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 10272, sell = 35, itemName = "crab pincers", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 9657, sell = 55, itemName = "cyclops toe", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 12316, sell = 550, itemName = "cavebear skull", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 17818, sell = 150, itemName = "cheesy figurine", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 11514, sell = 110, itemName = "colourful feather", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 7398, sell = 500, itemName = "cyclops trophy", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10398, sell = 15000, itemName = "draken trophy", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12309, sell = 800, itemName = "draptor scales", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 18994, sell = 115, itemName = "elven hoof", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 9648, sell = 30, itemName = "frosty ear of a troll", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12317, sell = 950, itemName = "giant crab pincer", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11539, sell = 20, itemName = "goblin ear", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12314, sell = 400, itemName = "hollow stampor hoof", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10282, sell = 600, itemName = "hydra head", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10455, sell = 80, itemName = "lancer beetle shell", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10419, sell = 8000, itemName = "lizard trophy", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11489, sell = 280, itemName = "mantassin tail", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 17461, sell = 65, itemName = "marsh stalker beak", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 17462, sell = 50, itemName = "marsh stalker feather", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12315, sell = 250, itemName = "maxilla", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 7401, sell = 500, itemName = "minotaur trophy", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 9662, sell = 420, itemName = "mutated bat ear", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12039, sell = 750, itemName = "panther head", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12040, sell = 300, itemName = "panther paw", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11491, sell = 500, itemName = "quara bone", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11491, sell = 350, itemName = "quara eye", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11490, sell = 410, itemName = "quara pincers", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 11487, sell = 140, itemName = "quara tentacle", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12172, sell = 50, itemName = "rabbit's foot", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 18993, sell = 70, itemName = "rorc feather", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10311, sell = 400, itemName = "sabretooth", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10456, sell = 20, itemName = "sandcrawler shell", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 9631, sell = 280, itemName = "scarab pincers", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12312, sell = 280, itemName = "stampor horn", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 12313, sell = 150, itemName = "stampor talons", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10454, sell = 60, itemName = "terramite legs", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10452, sell = 170, itemName = "terramite shell", storageKey = POINTSSTORAGE, storagevalue = 0},
	{clientId = 10273, sell = 95, itemName = "terrorbird beak", storageKey = POINTSSTORAGE, storagevalue = 0},
	-- Buy offers
	{clientId = 5907, buy = 35000, itemName = "slingshot", storageKey = POINTSSTORAGE, storageValue = 0},

	-- BigGameHunter rank
	{clientId = 10244, sell = 6000, itemName = "bonebeast trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7397, sell = 3000, itemName = "deer trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7400, sell = 3000, itemName = "lion trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7395, sell = 1000, itemName = "orc trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7394, sell = 3000, itemName = "wolf trophy", storageKey = POINTSSTORAGE, storageValue = 0},

	-- TrophyHunter rank
	-- Sell offers
	{clientId = 7396, sell = 20000, itemName = "behemoth trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7393, sell = 40000, itemName = "demon trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 7399, sell = 10000, itemName = "dragon lord trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 10421, sell = 3000, itemName = "disgusting trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 22101, sell = 9000, itemName = "werebadger trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 22102, sell = 10000, itemName = "wereboar trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 22103, sell = 11000, itemName = "werebear trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 27706, sell = 9000, itemName = "werefox trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	{clientId = 34219, sell = 12000, itemName = "werehyaena trophy", storageKey = POINTSSTORAGE, storageValue = 0},
	-- Buy offers
	{clientId = 9601, buy = 1000, itemName = "demon backpack", storageKey = POINTSSTORAGE, storageValue = 0}
}
