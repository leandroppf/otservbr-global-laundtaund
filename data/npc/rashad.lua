...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'Compro e vendo item de corno'})
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = 'I am rashad.'})

npcHandler:setMessage(MESSAGE_GREET, 'Anda logo corno')
