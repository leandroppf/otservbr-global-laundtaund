  ...
  -- Mounts
 {
   ...
   offers = {
        ...
        },
        {
          ...
          price = 870,
          id = 203,
          description = "{character}\n{speedboost}\n\n<i>If you are looking for a vigilant and faithful companion, look no further! Glide through every realm and stare into the darkest abyss on the back of a Parade Horse. They already know everything about you anyway for they have been watching you from the shadows!</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
        },
				{
          ...
          price = 870,
          id = 204,
          description = "{character}\n{speedboost}\n\n<i>If you are looking for a vigilant and faithful companion, look no further! Glide through every realm and stare into the darkest abyss on the back of a Jousting Horse. They already know everything about you anyway for they have been watching you from the shadows!</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
        },
				{
          ...
          price = 870,
          id = 205,
          description = "{character}\n{speedboost}\n\n<i>If you are looking for a vigilant and faithful companion, look no further! Glide through every realm and stare into the darkest abyss on the back of a Tourney Horse. They already know everything about you anyway for they have been watching you from the shadows!</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
        },
      },
   rookgaard = true,
 ...
 -- Base outfit has addon = 0 or no defined addon. By default addon is set to 0.
 {
   ...
   offers = {
        ...
        },
        {
          ...
          addon = 3,
          description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>A Fencer has dedicated their whole life to the study and mastery of runes. They are intrigued by the ancient symbols, shrouded in mystery, and how their magic works. Fencer have a deep understanding of the awesome power they are wielding and can make use of the full potential of runes.</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
        },
      },
   rookgaard = true,
